...
public extension WWNetworking {
    ...
    ///   - cachePolicy: [URLRequest.CachePolicy?](https://juejin.cn/post/6844904037821743112)
    ///   - httpBodyType: HttpBobyType?
    ///   - delegateQueue: OperationQueue?
    ///   - result: Result<ResponseInformation, Error>
    /// - Returns: URLSessionTask?
    @discardableResult
    func request(httpMethod: HttpMethod = .GET, urlString: String, timeout: TimeInterval = 60, contentType: ContentType = .json, paramaters: [String: String?]? = nil, headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, httpBodyType: HttpBobyType? = nil, delegateQueue: OperationQueue? = .current, result: @escaping (Result<ResponseInformation, Error>) -> Void) -> URLSessionTask? {
        let task = util.request(httpMethod: httpMethod, urlString: urlString, contentType: contentType, timeout: timeout, queryItems: paramaters?._queryItems(), headers: headers, cachePolicy: cachePolicy, httpBody: httpBodyType?.data(), delegate: dataDelegateProxy, delegateQueue: delegateQueue) { result($0) }
        return task
    }
    ...
    ///   - timeout: [設定請求超時時間](https://blog.csdn.net/qq_28091923/article/details/86233229)
    ///   - headers: [Http Header](https://zh.wikipedia.org/zh-tw/HTTP头字段)
    ///   - cachePolicy: [URLRequest.CachePolicy?](https://ithelp.ithome.com.tw/articles/10195605)
    ///   - delegateQueue: OperationQueue?
    ///   - result: Result<ResponseInformation?, Error>
    /// - Returns: URLSessionTask?
    @discardableResult
    func header(urlString: String, timeout: TimeInterval = 60, headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, delegateQueue: OperationQueue? = .current, result: @escaping (Result<ResponseInformation, Error>) -> Void) -> URLSessionTask? {
        
        let task = request(httpMethod: .HEAD, urlString: urlString, timeout: timeout, contentType: .plain, paramaters: nil, headers: headers, cachePolicy: cachePolicy, httpBodyType: nil, delegateQueue: delegateQueue) { _result in
    ...
    @discardableResult
    func upload(httpMethod: HttpMethod? = .POST, urlString: String, timeout: TimeInterval = 60, formData: FormDataInformation, parameters: [String: String]? = nil, headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, delegateQueue: OperationQueue? = .current, result: @escaping (Result<ResponseInformation, Error>) -> Void) -> URLSessionDataTask? {
        
        guard var request = URLRequest._build(string: urlString, httpMethod: httpMethod, headers: headers, cachePolicy: cachePolicy, timeout: timeout) else { result(.failure(CustomError.notUrlFormat)); return nil }
        
        let boundary = "Boundary+\(arc4random())\(arc4random())"
        let httpBody = util.multipleUploadBodyMaker(boundary: boundary, formDatas: [formData], parameters: parameters)
        
        request._setContentType(.formData(boundary: boundary))
    ...
    /// - Returns: URLSessionDataTask?
    @discardableResult
    func multipleUpload(httpMethod: HttpMethod? = .POST, urlString: String, timeout: TimeInterval = 60, formDatas: [FormDataInformation], parameters: [String: String]? = nil, headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, delegateQueue: OperationQueue? = .current, result: @escaping (Result<ResponseInformation, Error>) -> Void) -> URLSessionDataTask? {
    ...
    @discardableResult
    func binaryUpload(httpMethod: HttpMethod? = .POST, urlString: String, timeout: TimeInterval = 60, formData: FormDataInformation, headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, delegateQueue: OperationQueue? = .current, progress: @escaping ((UploadProgressInformation) -> Void), completion: @escaping (Result<Bool, Error>) -> Void) -> URLSessionUploadTask? {
        
        cleanAllBlocks()
        
        guard var request = URLRequest._build(string: urlString, httpMethod: httpMethod, headers: headers, cachePolicy: cachePolicy, timeout: timeout) else { completion(.failure(CustomError.notOpenURL)); return nil }
        
        let urlSession = URLSession(configuration: .default, delegate: dataDelegateProxy, delegateQueue: delegateQueue)
        var uploadTask: URLSessionUploadTask?
        
        request._setContentType(.custom(value: "\(formData.contentType)"))
    ...
    @discardableResult
    func download(httpMethod: HttpMethod? = .GET, urlString: String, timeout: TimeInterval = 60, configuration: URLSessionConfiguration = .default, headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, delegateQueue: OperationQueue? = .current, progress: @escaping ((DownloadProgressInformation) -> Void), completion: @escaping ((Result<DownloadResultInformation, Error>) -> Void)) -> URLSessionDownloadTask? {
        
        guard let downloadTask = util.downloadTaskMaker(with: httpMethod, urlString: urlString, timeout: timeout, configuration: configuration, headers: headers, cachePolicy: cachePolicy, delegate: downloadDelegateProxy, delegateQueue: delegateQueue) else { completion(.failure(CustomError.notUrlFormat)); return nil }
    ...
    /// - Returns: [URLSessionDownloadTask]
    @discardableResult
    func multipleDownload(httpMethod: HttpMethod = .GET, urlStrings: [String], timeout: TimeInterval = 60, configuration: URLSessionConfiguration = .default, headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, delegateQueue: OperationQueue? = .current, progress: @escaping ((DownloadProgressInformation) -> Void), completion: @escaping ((Result<DownloadResultInformation, Error>) -> Void)) -> [URLSessionDownloadTask] {
        
        cleanAllBlocks()
        
        let downloadTasks = urlStrings.compactMap { urlString in
            
            download(httpMethod: httpMethod, urlString: urlString, timeout: timeout, configuration: configuration, cachePolicy: cachePolicy, delegateQueue: delegateQueue) { info in
                progress(info)
    ...
    func fragmentDownload(httpMethod: HttpMethod = .GET, urlString: String, timeout: TimeInterval = .infinity, fragment: Int = 2, configiguration: URLSessionConfiguration = .default, headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, delegateQueue: OperationQueue? = .current, progress: @escaping ((DownloadProgressInformation) -> Void), fragmentTask: @escaping (URLSessionTask) -> Void, completion: @escaping ((Result<Data, Error>) -> Void)) {
        ...
        header(urlString: urlString, timeout: timeout, cachePolicy: cachePolicy) { result in
            ...
            case .success(let info):
                ...
                for index in 0..<fragment {
                    ...
                    let task = self.util.fragmentDownloadDataTaskMaker(httpMethod: httpMethod, urlString: urlString, offset: offset, timeout: timeout, configiguration: configiguration, headers: headers, cachePolicy: cachePolicy, delegate: self.dataDelegateProxy, delegateQueue: delegateQueue)
...
public extension WWNetworking {
    ...
    func request(httpMethod: HttpMethod = .GET, urlString: String, timeout: TimeInterval = 60, contentType: ContentType = .json, paramaters: [String: String?]? = nil, headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, httpBodyType: HttpBobyType? = nil, delegateQueue: OperationQueue? = .current) async -> Result<ResponseInformation, Error> {
        
        await withCheckedContinuation { continuation in
            request(httpMethod: httpMethod, urlString: urlString, timeout: timeout, contentType: contentType, paramaters: paramaters, headers: headers, cachePolicy: cachePolicy, httpBodyType: httpBodyType, delegateQueue: delegateQueue) { result in
    ...
    /// - Returns: [Result<ResponseInformation, Error>]
    /// - Parameters:
    ///   - types: [[RequestInformationType]](https://onevcat.com/2021/07/swift-concurrency/)
    ///   - cachePolicy: URLRequest.CachePolicy?
    func multipleRequest(types: [RequestInformationType], cachePolicy: URLRequest.CachePolicy? = nil) async -> [Result<ResponseInformation, Error>] {
        
        var requests: [Result<ResponseInformation, Error>] = []
        
        for type in types {
            async let request = request(httpMethod: type.httpMethod, urlString: type.urlString, timeout: type.timeout, contentType: type.contentType, paramaters: type.paramaters, headers: type.headers, cachePolicy: cachePolicy, httpBodyType: type.httpBodyType, delegateQueue: type.delegateQueue)
    ...
    /// 同時執行多個Request
    /// - Parameters:
    ///   - types: [RequestInformationType]
    ///   - cachePolicy: URLRequest.CachePolicy?
    /// - Returns: [Result<ResponseInformation, Error>]
    func multipleRequestWithTaskGroup(types: [RequestInformationType], cachePolicy: URLRequest.CachePolicy? = nil) async -> [Result<ResponseInformation, Error>] {
        
        await withTaskGroup(of: Result<ResponseInformation, Error>.self) { [self] group in
            
            for type in types {
                group.addTask {
                    await self.request(httpMethod: type.httpMethod, urlString: type.urlString, timeout: type.timeout, contentType: type.contentType, paramaters: type.paramaters, headers: type.headers, cachePolicy: cachePolicy, httpBodyType: type.httpBodyType, delegateQueue: type.delegateQueue)
                }
            }
    ...
    ///   - types: [RequestInformationType]
    ///   - cachePolicy: URLRequest.CachePolicy?
    /// - Returns: AsyncStream<Result<ResponseInformation, Error>>
    func multipleRequestWithStream(types: [RequestInformationType], cachePolicy: URLRequest.CachePolicy? = nil) -> AsyncStream<Result<ResponseInformation, Error>> {
    ...
    ///   - delegateQueue: OperationQueue?
    /// - Returns: Result<ResponseInformation, Error>
    func header(urlString: String, timeout: TimeInterval = 60, headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, delegateQueue: OperationQueue? = .current) async -> Result<ResponseInformation, Error> {
        
        await withCheckedContinuation { continuation in
            header(urlString: urlString, timeout: timeout, headers: headers, cachePolicy: cachePolicy, delegateQueue: delegateQueue) { result in
                continuation.resume(returning: result)
            }
        }
    }
    ...
    ///   - delegateQueue: OperationQueue?
    /// - Returns: Result<ResponseInformation, Error>
    func upload(httpMethod: HttpMethod? = .POST, urlString: String, timeout: TimeInterval = 60, formData: FormDataInformation, parameters: [String: String], headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, delegateQueue: OperationQueue? = .current) async -> Result<ResponseInformation, Error> {
        
        await withCheckedContinuation { continuation in
            upload(httpMethod: httpMethod, urlString: urlString, timeout: timeout, formData: formData, parameters: parameters, headers: headers, cachePolicy: cachePolicy, delegateQueue: delegateQueue) { result in
                continuation.resume(returning: result)
            }
        }
    }
    ...
    ///   - delegateQueue: OperationQueue?
    /// - Returns: Result<ResponseInformation, Error>
    func multipleUpload(httpMethod: HttpMethod? = .POST, urlString: String, timeout: TimeInterval = 60, formDatas: [FormDataInformation], parameters: [String: String], headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, delegateQueue: OperationQueue? = .current) async -> Result<ResponseInformation, Error> {
        
        await withCheckedContinuation { continuation in
            multipleUpload(httpMethod: httpMethod, urlString: urlString, timeout: timeout, formDatas: formDatas, parameters: parameters, headers: headers, cachePolicy: cachePolicy, delegateQueue: delegateQueue) { result in
                continuation.resume(returning: result)
            }
        }
    }
    ...
    func binaryUpload(httpMethod: HttpMethod? = .POST, urlString: String, timeout: TimeInterval = 60, formData: FormDataInformation, headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, delegateQueue: OperationQueue? = .current) -> AsyncThrowingStream<UploadEvent, Error> {
        
        AsyncThrowingStream { continuation in
            
            let task = binaryUpload(httpMethod: httpMethod, urlString: urlString, timeout: timeout, formData: formData, headers: headers, cachePolicy: cachePolicy, delegateQueue: delegateQueue) { progress in
    ...
    func download(httpMethod: HttpMethod? = .GET, urlString: String, timeout: TimeInterval = 60, configuration: URLSessionConfiguration = .default, headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, delegateQueue: OperationQueue? = .current) -> AsyncThrowingStream<DownloadEvent, Error> {
        
        AsyncThrowingStream { continuation in
            
            let task = download(httpMethod: httpMethod, urlString: urlString, timeout: timeout, configuration: configuration, headers: headers, cachePolicy: cachePolicy, delegateQueue: delegateQueue) { progress in
                continuation.yield(.progress(progress))
            } completion: { result in
                switch result {
    ...
    func fragmentDownload(urlString: String, fragment: Int = 10, timeout: TimeInterval = .infinity, configiguration: URLSessionConfiguration = .default, headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, delegateQueue: OperationQueue? = .current) -> AsyncThrowingStream<FragmentDownloadEvent, Error> {
        
        AsyncThrowingStream { continuation in
            
            var tasks: [URLSessionTask] = []
            
            fragmentDownload(urlString: urlString, timeout: timeout, fragment: fragment, configiguration: configiguration, headers: headers, cachePolicy: cachePolicy, delegateQueue: delegateQueue) { info in
    ...
    func multipleDownload(httpMethod: HttpMethod = .GET, urlStrings: [String], timeout: TimeInterval = 60, configuration: URLSessionConfiguration = .default, headers: [String: String?]? = nil, cachePolicy: URLRequest.CachePolicy? = nil, delegateQueue: OperationQueue? = .current) -> AsyncStream<Result<MultipleDownloadEvent, Error>>  {
        
        AsyncStream { continuation in
            
            let stateManager = MultipleDownloadStateManager()
            
            let tasks = multipleDownload(httpMethod: httpMethod, urlStrings: urlStrings, timeout: timeout, configuration: configuration, headers: headers, cachePolicy: cachePolicy, delegateQueue: delegateQueue) { progress in
